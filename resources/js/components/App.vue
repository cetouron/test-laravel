    ...
    <div class="dynamic-component-demo-personnalites-tab">
        <ul class="dynamic-component-demo-personnalites-sidebar">
          ...
          'dynamic-component-demo-active': personnalite === selectedPost
                ...
                @click="selectedPost = personnalite"
            >
            ...
            personnalites: [
                ...
                },
                {
                    ...
                    content:"<p>Robert Pattinson est un acteur, mannequin et musicien britannique, né le 13 mai 1986 à Barnes (Londres)1.\n" +
                        ...
                        "            </p>",
                    photo_url:"images/images/Robert_Pattinson_Premiere_of_The_Lost_City_of_Z_at_Zoo_Palast_Berlinale_2017_02.jpeg",
                },
                {
                    id: 3,
                    nom:"Law",
                    prenom: "Jude",
                    content:"<p>Jude Law est un acteur, réalisateur et producteur de cinéma britannique, né le 29 décembre 1972 à Lewisham (Londres).\n" +
                        ...
                        "                            En 2019, il joue le rôle de Yon-Rogg, un commandant Kree dans le film Captain Marvel, un film de l’univers cinématographique Marvel.</p>",
                    photo_url:"images/images/Jude_Law_2018.jpeg",
                },
                {
                    id: 4,
                    nom:"Gomez",
                    prenom: "Selena",
                    content:"<p>Selena Gomez, née le 22 juillet 1992 à Grand Prairie, au Texas, est une chanteuse, actrice et productrice américaine.\n" +
                        ...
                        "            </p>",
                    photo_url:"images/images/Selena_Gomez_2016.png",
                }
            ],
            selectedPost: null
        };
